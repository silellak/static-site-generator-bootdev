...
def generate_page(from_path, template_path, dest_path, basepath):
    ...
    final_content = template.replace("{{ Content }}", html_content).replace("href=/", f"href={basepath}/").replace("src=/", f"src={basepath}/")
    final_content = final_content.replace("{{ Title }}", title).replace("href=/", f"href={basepath}/").replace("src=/", f"src={basepath}/")
...
def generate_page_recursive(dir_path_content, template_path, dest_dir_path, basepath):
    ...
    for item in os.listdir(dir_path_content):
        ...
        if os.path.isfile(item_path) and item.endswith(".md"):
            ...
            generate_page_recursive(item_path, template_path, new_dest_dir_path, basepath)